...
public class LauncherGuideActivity extends Activity implements View.OnClickListener
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!LauncherCheck.isFirstRun(this)) {
            ...
            firstPage.setBackgroundResource(R.drawable.ic_launch_first);
            views.add(firstView);
            secondPage.setBackgroundResource(R.drawable.ic_launch_second);
            views.add(secondView);
            thirdPage.setBackgroundResource(R.drawable.ic_launch_third);
            views.add(thirdView);
            fourPage.setBackgroundResource(R.drawable.ic_launch_four);
            views.add(fourView);
            fivePage.setBackgroundResource(R.drawable.ic_launch_five);
            views.add(fiveView);

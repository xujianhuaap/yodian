...
public class UserDao {
    ...
    public static final String COLUMN_NAME_WECHAT = "wechat";
    ...
    public static final String ROBOT_COLUMN_NAME_WECHAT = "wechat";
    public static final String ROBOT_COLUMN_NAME_MOBILE = "mobile";
    public static final String ROBOT_COLUMN_NAME_QQ = "qq";
